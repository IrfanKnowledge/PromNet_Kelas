          ...
          <div class="col-xl-9 mx-auto" style="">
            ...
            <div class="cta-inner text-center rounded">
              ...
              <table cellpadding="10px" border="1px" cellspacing="0" bordercolor="black" align="center">
                <tr>
                  <td colspan="9" align="center"style="font-size: 25px;"><b>Riwayat_Transaksi</b></td>
                </tr>
                <tr style="font-size: 20px">
                  ...
                  <td><b>Paket</b></td>
                  <td><b>Jumlah_Pemesanan</b></td>
                  <td><b>Tanggal_Pemesanan</b></td>
                  <td><b>Total_Bayar</b></td>
                </tr>
              <?php
                  foreach ($Riwayat_Transaksi as $column)
                {
              ?>
                <tr>
                  ...
                  <td><?php echo $column->Paket; ?></td>
                  <td><?php echo $column->Jumlah_Pemesanan; ?></td>
                  <td><?php echo $column->Tanggal_Pemesanan; ?></td>
                  <td><?php echo $column->Total_Bayar; ?></td>
                </tr>
              <?php } ?>
            </table>
            <br><br>
